...
class ModelTraining:
    def __init__(self,data_path):
        ...
        self.experiment = comet_ml.Experiment(
             api_key="7scTZmZvcYTXcyDjmtoqOxZwN",
             project_name="Anime_recommendor",
             workspace="coderjaynt"
        )
    ...
    def train_model(self):
        try:
            ...
            try:
                ...
                raise CustomException("Model Taring Failed........")
    ...
    def save_model_weights(self,model):
        try:
            ...
            logger.info("User and Anime weights saved successfully......")
                ...
                raise CustomException("Error during saving model weights",e)
